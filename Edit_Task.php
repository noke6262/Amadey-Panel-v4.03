<?php
   ...
   { 
      ...
      if ($FT == 1)
      {
         ...
         MakeTaskAlt($_POST['path']  . ":::" . $_POST['dllfunction'], $_POST['tid'], $_POST['comment'], $_POST['arc'], "0", $FT, $_POST['folder'], $_POST['count'], $_POST['unitid'], $_POST['unitsid'], $_POST['country'], $_POST['group'], $_POST['id'], $_POST['ctlimit']); 
      }
      else
      {
         ...
         MakeTaskAlt($_POST['path'], $_POST['tid'], $_POST['comment'], $_POST['arc'], $_POST['run'], $FT, $_POST['folder'], $_POST['count'], $_POST['unitid'], $_POST['unitsid'], $_POST['country'], $_POST['group'], $_POST['id'], $_POST['ctlimit']); 
      }
