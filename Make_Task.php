<?php
   ...
   { 
      ...
      if ($FT == 1)
      {
         ...
         MakeTask($_POST['path']  . ":::" . $_POST['dllfunction'], $_POST['comment'], $_POST['arc'], "0", $FT, $_POST['folder'], $_POST['count'], $_POST['unitid'], $_POST['unitsid'], $_POST['country'], $_POST['group']); 
      }
      else
      {
         ...
         MakeTask($_POST['path'], $_POST['comment'], $_POST['arc'], $_POST['run'], $FT, $_POST['folder'], $_POST['count'], $_POST['unitid'], $_POST['unitsid'], $_POST['country'], $_POST['group']); 
      }
